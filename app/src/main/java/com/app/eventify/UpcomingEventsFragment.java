...
public class UpcomingEventsFragment extends Fragment {
    ...
    private UpcomingEventsRecyclerAdapter upcomingEventsRecyclerAdapter;
    ...
    private void loadEvents()
    {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                ...
                upcomingEventsRecyclerAdapter.notifyDataSetChanged();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        recyclerView = view.findViewById(R.id.upcomingEvent_recyclerView);
        formatter = new SimpleDateFormat("dd-MM-yyyy",Locale.ENGLISH);
        currentDate = getCurrentDate();
        upcomingEventsRecyclerAdapter = new UpcomingEventsRecyclerAdapter(eventInfoList);
        recyclerView.setHasFixedSize(true);
        mLayoutManager = new LinearLayoutManager(getActivity());
        recyclerView.setLayoutManager(mLayoutManager);

        upcomingEventsRecyclerAdapter.setOnItemClickListener(new UpcomingEventsRecyclerAdapter.OnItemClickListener()
        {
            @Override
